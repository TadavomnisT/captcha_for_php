...
$case_sensitivity = false; //Put true if you want to have case sensitive captcha and false if you don't
$str_rand = "";
for ($i=0; $i < $captcha_length ; $i++) $str_rand .= array_merge(range('a', 'z'), range(0 , 9))[ rand(0,35) ];
$str = "";
